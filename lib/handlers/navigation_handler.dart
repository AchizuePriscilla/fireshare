...
abstract class NavigationHandler {
  ...
  Future<dynamic>? popAndPushNamed(String destinationRoute, {dynamic arg, Object? result});
...
class NavigationHandlerImpl implements NavigationHandler {
  ...
  @override
  Future? popAndPushNamed(String destinationRoute, {arg, Object? result}) {
    if (state != null) {
      return state!.popAndPushNamed(destinationRoute, arguments: arg, result: result);
    }
  }
